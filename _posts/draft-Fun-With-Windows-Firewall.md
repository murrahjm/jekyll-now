...
* Compare-FirewallRules - Gets the existing local firewall rules from two servers, and outputs any rules from server1 that aren't already on server2.
* Copy-FirewallRules - Similar to Compare-FirewallRules, but takes any missing rules and creates them on server2
